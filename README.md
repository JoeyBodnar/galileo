Galileo is a Reddit browser for macOS that I've been building during my coronavirus quarantine time as a way to learn macOS programming. It is built with Swift and AppKit using Xcode 11.4. You can download the lateest release [here](https://github.com/JoeyBodnar/galileo/releases/download/0.1.3/galileo.zip)
